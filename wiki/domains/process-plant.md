...
4. Strengthen component behavior for the primary/secondary loop: feedwater inventory source/sink behavior, richer steam-generator secondary-side dynamics, and eventually a solved primary pressure field that uses the pressurizer state.
